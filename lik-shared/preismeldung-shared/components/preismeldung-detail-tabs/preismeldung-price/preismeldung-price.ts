...
import { ReactiveComponent, formatPercentageChange, maxMinNumberValidatorFactory, PefDialogService, PefMessageDialogService, preisNumberFormattingOptions, preisFormatFn, mengeNumberFormattingOptions, mengeFormatFn, parseErhebungsartForForm, PefDialogValidationErrorsComponent } from '../../../../';
...
export class PreismeldungPriceComponent extends ReactiveComponent implements OnChanges, OnDestroy {
    ...
    isAdminApp$ = this.observePropertyCurrentValue<boolean>('isAdminApp').publishReplay(1).refCount();
