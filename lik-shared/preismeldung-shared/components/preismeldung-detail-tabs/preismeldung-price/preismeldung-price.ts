                    ...
                    <div class="columns product-detail-row row-1">
                        <div class="last-period">
                            ...
                            <preismeldung-info-popover-left
                                [class.hidden]="
                                    !(preismeldung$ | async)?.refPreismeldung ||
                                    !(preismeldung$ | async)?.refPreismeldung.aktion
                                "
                                [preismeldung]="preismeldung$ | async"
                                [forceClose]="distinctPreismeldung$ | async"
                                [extraWidth]="window.document.getElementById('row-1-middle-section').offsetWidth + 'px'"
                                [height]="'0px'"
                        ...
                        <div class="current-period" id="row-1-current-period">
                            ...
                            <preismeldung-info-popover-right
                                [class.hidden]="
                                    (preismeldung$ | async)?.preismeldung.bearbeitungscode != 1 ||
                                    !(preismeldung$ | async)?.preismeldung.aktion
                                "
                                [preismeldung]="preismeldung$ | async"
                                [forceClose]="closePopoverRight$ | async"
                                [popoverLeft]="
                                    window.document.getElementById('row-1-middle-section').offsetWidth +
                                    'px + ' +
                                    window.document.getElementById('row-1-current-period').offsetWidth +
                                    'px'
                                "
                                [width]="window.document.getElementById('row-1-current-period').offsetWidth + 'px'"
                                [height]="'0px'"
                    ...
                    >
                        ...
                        <div
                            ...
                            *ngIf="(preismeldung$ | async)?.refPreismeldung"
                            id="row-2-last-period"
                        >
                            <div class="data-input-area" id="last-period-data-input-area">
                                <h6>
                                    {{
                                        ((infoPopoverLeftActive$ | async)
                                            ? 'heading_artikel-vor-reduktion'
                                    ...
                                    <div class="number">
                                        {{
                                            ((infoPopoverLeftActive$ | async)
                                                ...
                                                : (preismeldung$ | async)?.refPreismeldung.preis)
                                                | pefFormatNumber: preisNumberFormattingOptions
                                        }}
                                    </div>
                                    ...
                                    <div class="number">
                                        {{
                                            ((infoPopoverLeftActive$ | async)
                                                ...
                                                : (preismeldung$ | async)?.refPreismeldung.menge)
                                                | pefFormatNumber: mengeNumberFormattingOptions
                                        }}
                                    </div>
                                    <div class="unit">
                                        {{
                                    ...
                                    <ion-list radio-group>
                                        <ion-item>
                                            ...
                                            <ion-radio
                                                value="aktion"
                                                [disabled]="true"
                                                [checked]="(preismeldung$ | async)?.refPreismeldung?.aktion"
                                            ></ion-radio>
                                        </ion-item>
                                    </ion-list>
                                    <div class="code">
                                        {{
                                            formatFehlendePreiseR(
                                                (preismeldung$ | async)?.refPreismeldung?.fehlendePreiseR
                                            )
                                        }}
                                    </div>
                                </div>
                            ...
                            <div class="box-container" [class.visibility-hidden]="!(showVPArtikelNeu$ | async)">
                                <div class="box">
                                    <div class="percentage-wrapper">
                                        <div
                                            [innerHTML]="formatPercentageChange((arrowDown$ | async)?.percentage)"
                                        ></div>
                                        <pef-floating-icon
                        ...
                        <div class="middle-section">
                            <div class="box-container" *ngIf="!!(preismeldung$ | async)?.refPreismeldung">
                                <div class="box">
                                    <div class="percentage-wrapper">
                                        <div
                                            [innerHTML]="formatPercentageChange((arrowRight$ | async)?.percentage)"
                                        ></div>
                                        <pef-floating-icon
                            ...
                            <div class="data-input-area">
                                ...
                                <ion-list *ngIf="!(infoPopoverRightActive$ | async)">
                                    ...
                                    >
                                        ...
                                        <ion-input
                                            ...
                                            (input)="preisInput$.emit($event.target.value)"
                                    ...
                                    <div class="unit-item-wrapper">
                                        ...
                                        >
                                            <ion-input
                                                ...
                                                (input)="mengeInput$.emit($event.target.value)"
                                            ></ion-input>
                                        </ion-item>
                                ...
                                <ion-list *ngIf="infoPopoverRightActive$ | async">
                                    ...
                                    >
                                        ...
                                        <ion-input
                                            ...
                                            pef-disable-input-negative-number
                                            [class.ng-invalid]="createInvalidObservableFor('preisVorReduktion') | async"
                                            (blur)="preisVorReduktionChanged$.emit(preisVorReduktion.value)"
                                            (input)="preisVorReduktionInput$.emit($event.target.value)"
                                            [readonly]="isReadonly$ | async"
                                            [class.readonly]="isReadonly$ | async"
                                    ...
                                    <div class="unit-item-wrapper">
                                        ...
                                        >
                                            <ion-input
                                                ...
                                                pef-disable-input-negative-number
                                                [class.ng-invalid]="
                                                    createInvalidObservableFor('mengeVorReduktion') | async
                                                "
                                                (blur)="mengeVorReduktionChanged$.emit(mengeVorReduktion.value)"
                                                (input)="mengeVorReduktionInput$.emit($event.target.value)"
                                                [readonly]="isReadonly$ | async"
                                                [class.readonly]="isReadonly$ | async"
                                ...
                                <div class="current-period-aktion-row">
                                    ...
                                    <div
                                        ...
                                        [class.visibility-hidden]="
                                            !formatFehlendePreiseR(
                                                (preismeldung$ | async)?.preismeldung.fehlendePreiseR
                                            )
                                        "
                                    >
                                        {{
                                            formatFehlendePreiseR((preismeldung$ | async)?.preismeldung.fehlendePreiseR)
                                        }}
                                    </div>
                                </div>
                                <bearbeitungs-type
                                    ...
                                    [readonly]="isReadonly$ | async"
                                    [nichtEmpfohleneBc]="
                                        (distinctPreismeldung$ | async)?.warenkorbPosition.nichtEmpfohleneBc
                                    "
                                ></bearbeitungs-type>
                            </div>
                        </div>
                    ...
                    <div class="columns product-detail-row row-3">
                                ...
                                <ion-list>
                                    ...
                                    >
                                        ...
                                        <ion-input
                                            ...
                                            pef-disable-input-negative-number
                                            [class.ng-invalid]="createInvalidObservableFor('preisVPK') | async"
                                            (blur)="preisVPKChanged$.emit(preisVPK.value)"
                                            [readonly]="isReadonly$ | async"
                                            [class.readonly]="isReadonly$ | async"
                                    ...
                                    <div class="unit-item-wrapper">
                                        ...
                                        >
                                            <ion-input
                                                ...
                                                pef-disable-input-negative-number
                                                [class.ng-invalid]="createInvalidObservableFor('mengeVPK') | async"
                                                (blur)="mengeVPKChanged$.emit(mengeVPK.value)"
                                                [readonly]="isReadonly$ | async"
                                                [class.readonly]="isReadonly$ | async"
                                    ...
                                    <div class="box">
                                        <div class="percentage-wrapper">
                                            <div
                                                [innerHTML]="
                                                    formatPercentageChange(
                                                        (preismeldung$ | async)?.preismeldung.d_DPToVPK.percentage
                                                    )
                                                "
                                            ></div>
                                            <pef-floating-icon
                                                [icon-name]="
                                                    (preismeldung$ | async)?.preismeldung.d_DPToVPK.warning
                                                        ? 'warning'
                                                        : ''
                                                "
                                                [bottom-right]="true"
                        ...
                        <div class="current-period">
                            <div class="textzeil" *ngIf="(preismeldung$ | async)?.textzeile?.length">
                                <span
                                    *ngFor="let textzeil of (preismeldung$ | async)?.textzeile"
            ...
            mergeMap(({ saveAction, bag, isAdminApp }) => {
                const alerts: {
                    ...
                    },
                    {
                        ...
                        observable: () =>
                            pefMessageDialogService.displayDialogYesNo('dialogText_unveraendert-pm-text').map(res =>
                                res.data === 'YES'
                                    ? {
                                          type: saveAction.type,
                                          saveWithData: [
                                              {
                                                  type: 'COMMENT',
                                                  comments: ['kommentar-autotext_artikeltext-unveraendert-bestaetigt'],
                                              },
                                          ],
                                      }
                                    : { type: 'CANCEL' },
