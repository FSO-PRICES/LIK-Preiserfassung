                    ...
                    <div class="info-warenkorb-table">
                        <div class="info-warenkorb-row">
                            ...
                            <div class="info-warenkorb-cell value">
                                {{ (preismeldung$ | async)?.warenkorbPosition.standardmenge }}
                        ...
                        <div class="info-warenkorb-row">
                            ...
                            <div
                                ...
                                [innerHTML]="(preismeldung$ | async)?.warenkorbPosition.info || '&ndash;'"
                            ></div>
                        </div>
                        <div class="info-warenkorb-row">
                            <div class="info-warenkorb-cell heading">
                            ...
                            <div
                                class="info-warenkorb-cell value"
                                [innerHTML]="
                                    ((preismeldung$ | async)?.warenkorbPosition.beispiele | pefPropertyTranslate) ||
                                    '&ndash;'
                                "
                            ></div>
                        </div>
                        <div class="info-warenkorb-row" *ngIf="!!(preismeldung$ | async)?.refPreismeldung">
                            ...
                            <div class="info-warenkorb-cell value">
                                Von {{ (preismeldung$ | async)?.refPreismeldung?.erhebungsAnfangsDatum }} <br />
                                bis {{ (preismeldung$ | async)?.refPreismeldung?.erhebungsEndDatum }}
                            </div>
                        </div>
                        <div class="info-warenkorb-row">
                            <div class="info-warenkorb-cell heading">
                            ...
                            <div class="info-warenkorb-cell value">
                                ...
                                <ul class="month-list">
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 0)
                                        "
                                    >
                                        {{ 1 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 1)
                                        "
                                    >
                                        {{ 2 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 2)
                                        "
                                    >
                                        {{ 3 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 3)
                                        "
                                    >
                                        {{ 4 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 4)
                                        "
                                    >
                                        {{ 5 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 5)
                                        "
                                    >
                                        {{ 6 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 6)
                                        "
                                    >
                                        {{ 7 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 7)
                                        "
                                    >
                                        {{ 8 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 8)
                                        "
                                    >
                                        {{ 9 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 9)
                                        "
                                    >
                                        {{ 10 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 10)
                                        "
                                    >
                                        {{ 11 | pefMonthTranslate }}
                                    </li>
                                    <li
                                        *ngIf="
                                            ifMonth((preismeldung$ | async)?.warenkorbPosition.periodizitaetMonat, 11)
                                        "
                                    >
                                        {{ 12 | pefMonthTranslate }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="info-warenkorb-row">
                            ...
                            <div class="info-warenkorb-cell value">
                                {{ (preismeldung$ | async)?.warenkorbPosition.negativeLimite }}%&nbsp;/&nbsp;+{{
                                    (preismeldung$ | async)?.warenkorbPosition.positiveLimite
                                }}%
                            </div>
                        </div>
                        <div class="info-warenkorb-row">
                            ...
                            <div class="info-warenkorb-cell value">
                                {{ (preismeldung$ | async)?.warenkorbPosition.negativeLimite_1 }}%&nbsp;/&nbsp;+{{
                                    (preismeldung$ | async)?.warenkorbPosition.positiveLimite_1
                                }}%
                            </div>
                        </div>
                        <div class="info-warenkorb-row">
                            ...
                            <div class="info-warenkorb-cell value">
                                {{ (preismeldung$ | async)?.warenkorbPosition.negativeLimite_7 }}%&nbsp;/&nbsp;+{{
                                    (preismeldung$ | async)?.warenkorbPosition.positiveLimite_7
                                }}%
                            </div>
                        </div>
