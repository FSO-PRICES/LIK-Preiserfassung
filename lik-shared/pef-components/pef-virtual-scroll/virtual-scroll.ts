...
import { PefVirtualFooter, PefVirtualHeader, PefVirtualItem } from './virtual-item';


function isBlank(val: any) { return val === undefined || val === null; }
function isFunction(val: any) { return typeof val === 'function'; }
function isPresent(val: any) { return val !== undefined && val !== null; }
 ...
 */
@Directive({
    selector: '[pefVirtualScroll]'
})
export class PefVirtualScroll implements DoCheck, AfterContentInit, OnDestroy {
    _differ: any;
    _scrollSub: any;
    _scrollEndSub: any;
    _init: boolean;
    ...
    @ContentChild(PefVirtualItem) _itmTmp: PefVirtualItem;
    @ContentChild(PefVirtualHeader) _hdrTmp: PefVirtualHeader;
    @ContentChild(PefVirtualFooter) _ftrTmp: PefVirtualFooter;
