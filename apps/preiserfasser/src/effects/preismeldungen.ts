...
import { flatMap as arrayFlatMap, assign, cloneDeep, isEqual, sortBy } from 'lodash';
...
export class PreismeldungenEffects {
    ...
    // TODO Fix types
    loadPreismeldungen$ = createEffect(() =>
        this.actions$.pipe(
                            ...
                            currentPreismeldung =
                                x.currentPreismeldung.preismeldung.bearbeitungscode === 0
                                    ...
                                    : assign(
                                          ...
                                          x.currentPreismeldung,
                                          {
                                              messages: assign({}, x.currentPreismeldung.messages, {
                                                  kommentarAutotext,
                                              }),
                                          },
                                          setAktion,
    ...
    saveNewPreismeldung$ = createEffect(() =>
        this.savePreismeldungPrice$.pipe(
            filter((x) => x.currentPreismeldung.isNew),
            flatMap((pmPrice) =>
                defer(() => {
                                            ...
                                            sortOrder: [
                                                ...
                                                ...pmsPreismeldungenSort.sortOrder
                                                    .filter(
                                                        (x) =>
                                                            x.sortierungsnummer >=
                                                            currentPreismeldung.sortierungsnummer,
                                                    )
                                                    .map((x) => ({
                                                        pmId: x.pmId,
    ...
    preismeldungenSortSave = createEffect(() =>
        this.actions$.pipe(
