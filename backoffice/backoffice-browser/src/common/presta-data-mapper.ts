...
if (!docuri) throw Error("Cannot use common/presta-data-mapper without the docuri npm package")
...
export function createPmsToPeMap(lines: string[][]) {
...
export function preparePms(data: {lines: string[][], preismeldestellen: PmsToPeMap}) {
