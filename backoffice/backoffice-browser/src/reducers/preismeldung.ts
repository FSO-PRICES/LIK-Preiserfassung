...
export * from '../pages/preismeldung/components/preismeldung-shared/reducers/preismeldung.reducer';
// import { Action as PreismeldungAction } from '../actions/preismeldung';
...
//             const currentPreismeldung = action.payload == null ? null : Object.assign({}, cloneDeep(state.entities[action.payload]), { isModified: false });
