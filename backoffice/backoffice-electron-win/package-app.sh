...
./node_modules/.bin/electron-packager . --tmpdir=$1/electron/ --out=$2/build/electron --platform=win32 --arch=ia32 --no-prune --appname=bfs-lik-preiserfasser.exe --app-copyright="Schweizerische Eidgenossenschaft Bundesamt fuer Statistik" --win32metadata.CompanyName="Schweizerische Eidgenossenschaft Bundesamt fuer Statistik" --win32metadata.ProductName="BFS LIK Backoffice" --win32metadata.FileDescription="BFS LIK Backoffice"
