...
export class ChooseFromWarenkorbComponent extends ReactiveComponent implements OnChanges, OnDestroy {
    ...
    constructor(
        ...
        const preismeldungen$ = this.observePropertyCurrentValue<P.PreismeldungBag[]>('preismeldungen').filter(
            x => !!x
        );
        ...
        const warenkobUiItemsFiltered$ = warenkobUiItems$
            .combineLatest(
                this.searchString$.debounceTime(500).startWith(null),
        ...
        const clickAction$ = this.warenkorbItemClicked$
        ...
        this.numberOfEp$ = warenkobUiItemsFiltered$
        ...
        this.closeChooseFromWarenkorb$ = this.selectWarenkorbItem$
