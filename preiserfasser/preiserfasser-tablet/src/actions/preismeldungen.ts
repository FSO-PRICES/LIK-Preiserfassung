...
export type Actions =
    ...
    { type: 'PREISMELDUNGEN_LOAD_SUCCESS', payload: { warenkorbDoc: { products: P.Models.WarenkorbTreeItem[] }, refPreismeldungen: P.Models.PreismeldungReference[], preismeldungen: P.Models.Preismeldung[] } } |
