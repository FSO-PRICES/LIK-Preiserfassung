    ...
    constructor(
        ...
        this.subscriptions = [
            ...
            this.navigateToPriceEntry$
                .pipe(delay(100))
                .subscribe(pms =>
                    this.navCtrl.navigateRoot('PmsPriceEntryPage', { queryParams: { pmsNummer: pms.pmsNummer } }),
                ),

            this.navigateToPreiserheber$
                .pipe(delay(100))
                .subscribe(() => this.navCtrl.navigateRoot('PreiserheberPage')),

            this.navigateToSettings$.pipe(delay(100)).subscribe(() => this.navCtrl.navigateRoot('SettingsPage')),

            this.navigateToDetails$
                .pipe(delay(100))
                .subscribe(pms =>
                    this.navCtrl.navigateRoot('PmsDetailsPage', { queryParams: { pmsNummer: pms.pmsNummer } }),
                ),
