...
import { PreismeldungDetailPriceComponent, DialogCancelEditComponent, DialogValidationErrorsComponent } from './components/preismeldung-detail-tabs/preismeldung-detail-price';
